...
// Using let
let name = "Elton James"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["gaming", "fitness", "coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["Atomic Habits", "The Subtle Art of Not Giving A F*ck"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Marilao"; // Define a string here, e.g., "New York"
var temperature = 23; // Define a number here, e.g., 22.5
